...
public class ID3Classifier extends LetterClassifier {
   ...
   * @param proportionThresh the proportion of examples in a partition that should match for a leaf node to be made
   * @param numSamplesThresh the largest number of samples left in a partition after which a leaf node should be made
   */
  public void train(ClassifiedBitmap[] maps, double proportionThresh, int numSamplesThresh) {
    ...
    tree=id3.induce(proportionThresh, numSamplesThresh);
  }
