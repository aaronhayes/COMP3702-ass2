...
/**
 * <p>The user interface used by UseClassifier.</p>
 * @author Mikael Bodén
 * @version 1.0
 */
...
public class BitmapFrame extends JFrame {
  ...
  public void readClassifier(String fname) throws IOException, ClassNotFoundException {
  ...
  void jMenuLoad_actionPerformed(ActionEvent e) {
    ...
    if (fc.showOpenDialog(this)==JFileChooser.APPROVE_OPTION) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(this, "Could not open file", "IOException: "+filename, JOptionPane.ERROR_MESSAGE);
      } catch (ClassNotFoundException ex) {
        JOptionPane.showMessageDialog(this, "Could not process file (incorrect class definition)", "ClassNotFoundException: "+filename, JOptionPane.ERROR_MESSAGE);
      } catch (Exception ex) {
        JOptionPane.showMessageDialog(this, "Could not process file", ex.getMessage()+": "+filename, JOptionPane.ERROR_MESSAGE);
      }
      repaint();
    }
  }
